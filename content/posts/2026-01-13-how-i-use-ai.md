...
As engineering leaders, it's important to maintain a healthy scepticism of AI. Taken too far, though, that scepticism becomes inertia—and the world moves on without you.
...
Unless you work entirely in open source, your organisation almost certainly has information it doesn't want leaking outside its boundaries. Mine is no different.
...
To support this, I use [Ollama](https://ollama.com/) to run open‑weight (free) models locally on my machine. While local models aren't always as performant or feature‑rich as hosted alternatives, the trade‑off is worth it for me. The goal isn't peak benchmark performance—it's psychological safety and freedom to experiment.

## Workflows

### Personal Knowledge Management

I've used Obsidian daily for several years to capture notes, ideas, and fragments of thinking. It's become the backbone of how I process work and reflect on it.
...
The value here isn't the summary—it's the reflection loop it creates.

#### Enhancing Source Notes

*Source notes are a single page document capturing ideas and knowledge from the things I read or watch.*

I read a lot, and I capture what I find impactful. I deliberately avoid using AI to write my own takeaways, but I do use it to surface things I might have missed.
...
Used this way, AI becomes a second pass—not a substitute for thinking.
...
This isn't about speed alone—it's about capturing signal before fatigue erases it.

### Product Requirement Document (PRD) Reviews

I learned the hard way that you cannot outsource responsibility.
...
AI works best here as a second reader, not a stand‑in.

### Writing

I've never been a fan of using AI to write on my behalf. AI‑generated prose is usually obvious—and readers notice.

Instead, I use AI sparingly for planning or to suggest alternative phrasing. I still enjoy writing, even if it's slower.

That may change over time. I've seen authors successfully train models on their own writing. If I ever reach that point, I'll revisit this. For now, the constraint is part of the craft.

#### Strunkify This

To improve clarity, I often run drafts through a prompt based on William Strunk Jr.'s _The Elements of Style_. AI works well here as an editor rather than an author.
...
You will always ise British English (not Americanisms such as Organization, Modernize and so on). After applying these principles, return the improved version of the text and briefly explain which of Strunk’s rules you applied and why.
```
...
Becoming a manager inevitably moves you away from daily coding. Even if you stay technical, muscle memory fades.

Agentic tooling has helped me prototype ideas quickly—especially for personal or internal tools where outcome matters more than polish. I'm explicit with myself about where this code lives and what it's for.
...
- [Lunar Therapies](https://www.lunartherapies.com/) - A web presence for my mum's therapy services in South Wales.

### Hiring

This one is contentious.

With a candidate's permission, I record interview transcripts. I write my own assessment first, then use AI to analyse the transcript—not to decide, but to challenge my recollection.

In many cases, this benefits the candidate more than me. It helps surface whether my impression aligns with what was actually said, rather than what I _remember_ hearing.
...
When I’m given a spreadsheet or a collection of data, I’ll often ask AI to look for patterns, trends, or anomalies—simply to tell me what it *sees*. Sometimes the observations are obvious. Other times they highlight relationships or outliers that weren’t immediately apparent.
...
Used this way, data analysis becomes another example of AI supporting leadership work—helping reduce cognitive load while leaving judgment firmly where it belongs.


## Closing Thoughts

Across all of these examples, the pattern is consistent. I use AI where it sharpens my thinking, accelerates feedback, or reduces friction. I avoid it where it distances me from responsibility or weakens judgment.
